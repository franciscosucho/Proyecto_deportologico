...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 23-08-2024 a las 14:42:27
...
--
ALTER TABLE `actividad_dia` ADD PRIMARY KEY (`ID_act`),
ADD KEY `Dni_act` (`Dni_act`);

--
-- Indices de la tabla `deportivousuario`
--
ALTER TABLE `deportivousuario` ADD PRIMARY KEY (`ID_depor`),
...
--
ALTER TABLE `nutricionalusuario` ADD PRIMARY KEY (`ID_nut`),
ADD KEY `DNI_nut` (`DNI_nut`);

--
-- Indices de la tabla `profesional`
--
ALTER TABLE `profesional` ADD PRIMARY KEY (`ID`);

--
-- Indices de la tabla `progreso`
--
ALTER TABLE `progreso` ADD PRIMARY KEY (`ID`),
ADD KEY `DNI_prog` (`DNI_prog`);

--
-- Indices de la tabla `racha`
--
ALTER TABLE `racha` ADD PRIMARY KEY (`ID_racha`),
...
--
ALTER TABLE `actividad_dia` MODIFY `ID_act` int (11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT de la tabla `deportivousuario`
--
ALTER TABLE `deportivousuario` MODIFY `ID_depor` int (11) NOT NULL AUTO_INCREMENT,
AUTO_INCREMENT = 17;
...
--
ALTER TABLE `nutricionalusuario` MODIFY `ID_nut` int (11) NOT NULL AUTO_INCREMENT,
AUTO_INCREMENT = 18;

--
-- AUTO_INCREMENT de la tabla `profesional`
--
ALTER TABLE `profesional` MODIFY `ID` int (11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT de la tabla `progreso`
--
ALTER TABLE `progreso` MODIFY `ID` int (11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT de la tabla `racha`
--
ALTER TABLE `racha` MODIFY `ID_racha` int (11) NOT NULL AUTO_INCREMENT;
...
--
ALTER TABLE `actividad_dia` ADD CONSTRAINT `actividad_dia_ibfk_1` FOREIGN KEY (`Dni_act`) REFERENCES `usuario` (`DNI`);

--
-- Filtros para la tabla `deportivousuario`
--
ALTER TABLE `deportivousuario` ADD CONSTRAINT `deportivousuario_ibfk_1` FOREIGN KEY (`DNI_depor`) REFERENCES `usuario` (`DNI`);

--
-- Filtros para la tabla `nutricionalusuario`
--
ALTER TABLE `nutricionalusuario` ADD CONSTRAINT `nutricionalusuario_ibfk_1` FOREIGN KEY (`DNI_nut`) REFERENCES `usuario` (`DNI`);

--
-- Filtros para la tabla `progreso`
--
ALTER TABLE `progreso` ADD CONSTRAINT `progreso_ibfk_1` FOREIGN KEY (`DNI_prog`) REFERENCES `usuario` (`DNI`);

--
-- Filtros para la tabla `racha`
--
ALTER TABLE `racha` ADD CONSTRAINT `racha_ibfk_1` FOREIGN KEY (`Dni_racha`) REFERENCES `usuario` (`DNI`);
